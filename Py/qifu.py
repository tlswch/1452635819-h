...
class Spider(Spider):  # 元类 默认的元类 type
	...
	def categoryContent(self,tid,pg,filter,extend):
		...
		if 'id' not in extend.keys():
			extend['id'] = tid
		extend['page'] = pg
		filterParams = ["id", "area", "by", "class", "lang", "", "", "", "page", "", "", "year"]#应该是“内置了12个参数0~11,id=0,page=8”
		params = ["", "", "", "", "", "", "", "", "", "", "", ""]
	...
	def detailContent(self,array):
		...
		vod_play_from = '$$$'
		playFrom = []
		#vodHeader = root.xpath("//div[@class='stui-vodlist__head']//li/a/text()")#href="#playlist13"=[contains(@href,'playlist')]
		vodHeader = root.xpath(".//div[@class='stui-vodlist__head']//li/a[contains(@href,'playlist')]/text()")
		for v in vodHeader:
			playFrom.append(v)
