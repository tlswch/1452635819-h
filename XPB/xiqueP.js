{
  ...
  "homeVodNode": "//a[contains(@class,'module-poster-item module-item')]",
  "homeVodName": "/@title",
  "homeVodNameR": "",
  "homeVodId": "/@href",
  "homeVodIdR": "/voddetail/(\\w+).html",
  "homeVodImg": "//div[contains(@class,'module-item-pic')]/img/@data-original",
  "homeVodImgR": "",
  "homeVodMark":  "//div[contains(@class,'module-item-note')]/text()",
  "homeVodMarkR": "",
  "cateUrl": "https://www.ak1080.me/vodshow/{cateId}--------{catePg}---.html",
  "cateVodNode": "//a[contains(@class,'module-poster-item module-item')]",
  "cateVodName": "/@title",
  "cateVodId": "/@href",
