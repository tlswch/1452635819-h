{ //2022.6.8
  ...
  "dcVipFlag": "true",
  "dcPlayUrl": "true",
  "cateNode": "//ul[contains(@class,'myui-header__menu')]/li[@class='dropdown-hover']//ul/li/a[contains(@href, 'vodtype') and not(contains(@href, '30'))]",
  "cateName": "/text()",
  "cateId": "/@href",
  "cateIdR": "/vodtype/(\\d+).html",
  "cateManual": { "电影": "1","连续剧": "2","动漫": "3","综艺": "4"},
  ...
  "cateUrl": "https://www.ysgc.cc/vodshow/{cateId}-{area}-{by}-{class}-{lang}----{catePg}---{year}.html",
  ...
  "dtDirectorR": "",
  "dtDesc": "//div[@class='col-pd text-collapse content']/span[2][@class='data']/p/text()",
