{
  "author":"20220606",
  "name": "黑洞影院",
  "url": "https://nulltm.com/", //填网站链接
  "tihuan": "cnzz.com", //这个不用动，是个别网站嗅探时过滤地址用的
  "User": "空", //这个不用动，是个别网站播放需要请求头时才用到
  "shouye": "1",

  "fenlei": "电影$/vodshow/1--------#连续剧$/vodshow/2--------#动作剧$/vodshow/2---动作-----#犯罪剧$/vodshow/2---犯罪-----#奇幻剧$/vodshow/2---奇幻-----#历史剧$/vodshow/2---历史-----#古装剧$/vodshow/2---古装-----#战争剧$/vodshow/2---战争-----#综艺$/vodshow/3--------#动漫$/vodshow/4--------", //网站列表的分类
  "houzhui": "---.html", //网站翻页链接的后缀

  "shifouercijiequ": "1", //截取的列表数组是否需要二次截取，0不需要，1需要
  "jiequqian": "class=\"hl-vod-list", //不需要二次截取就填空
  "jiequhou": "</ul>", //不需要二次截取就填空
  "jiequshuzuqian": "class=\"hl-item-thumb", //截取的列表数组的前关键词,截取的关键词有 " 的用 \ 进行转义
  ...
  //"fubiaotiqian": "class=\"hl-lc-1 remarks\">",
  //"fubiaotihou": "</span>",
  ...
  "bfjiequqian": "空",
  "bfjiequhou": "空",
  "bfjiequshuzuqian": "id=\"hl-plays-list", //播放截取的列表数组的前关键词
  "bfjiequshuzuhou": "</ul>", //播放截取的列表数组的后关键词

  "zhuangtaiqian": "更新：</em>", //状态前关键词
  "zhuangtaihou": "</li>", //状态后关键词
  "daoyanqian": "导演：</em>", //导演前关键词
