{// 尤东风于2022.6.17再次编制
  ...
  "cateUrl": "https://555dy.fun/vodshow/{cateId}---{area}-{by}----{catePg}---{year}.html",
  ...
  "dtUrl": "https://555dy.fun/voddetail/{vid}.html",
  ...
  "dtImgR": "\\S+(http\\S+)",
  "dtCate": "//[@class='module-info-tag']/div[@class='module-info-tag-link'][3]/a/text()",
  "dtCateR": "",
  "dtYear": "//div[@class='module-info-tag']/div[contains(@class,'module-info-tag-link')]/a/text()",
  "dtYearR": "",
  "dtArea": "//[@class='module-info-tag']/div[@class='module-info-tag-link'][2]/a/text()",
  "dtAreaR": "",
  "dtMark": "",
  "dtMarkR": "",
  ...
  "dtUrlName": "/span/text()",
  "dtUrlNameR": "",
  "playUrl": "https://555dy.fun/vodplay/{playUrl}.html",
  "playUa": "",
  "searchUrl": "https://555dy.fun/index.php/ajax/suggest?mid=1&wd={wd}&limit=10",
  "scVodNode": "json:list",
  "scVodName": "name",
  "scVodId": "id",
  "scVodIdR": "",
