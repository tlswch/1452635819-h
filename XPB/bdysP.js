//最新域名 www.btbdys.com，备用域名 bde4.icu,旧站https://www.mp4er.cc/,https://www.52bdys.com/
{
	"ua": "",
	...
	"dtName": "//h2/text()",
	"dtNameR": "",
	"dtImg": "//div[@class='col-md-auto col-5 cover-lg-max-25']/img/@src",
	"dtImgR": "\\S+(http\\S+)",
	...
	"dtFromNode": "//tbody[contains(@id,'download-list')]/tr[1]",
    ...
    //"dtUrlName": "/text()",
    //"dtUrlNameR": "",
    //"playUrl": "https://www.52bdys.com/play/{playUrl}.html",
	"playUa": "",
