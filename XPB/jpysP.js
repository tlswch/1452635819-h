{//标准的首页直接分类型(2022.6.15)
  ...
  "dtDescR": "",
  //"dtFromNode": "//a[@data-toggle='tab' and contains(@href, 'playlist')]",  //原文
  "dtFromNode": "//a[@data-toggle='tab']",
  "dtFromName": "/text()",
  "dtFromNameR": "",
  //"dtUrlNode": "//div[contains(@class,'tab-content')]/div[contains(@id, 'playlist')]",  //原文与上面的原文配套用
  "dtUrlNode": "//div[contains(@class,'tab-content')]/div[contains(@class, 'tab-pane fade in')]",
  "dtUrlSubNode": "//li/a",
  "dtUrlId": "@href",
